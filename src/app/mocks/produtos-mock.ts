...
export const COMIDAS: Comida[]  = [
    new Comida(1, 'Temaki', 20, true, 'comida', INGREDIENTES_TEMAKI),
    new Comida(2, 'Hossomaki', 10, true, 'comida', INGREDIENTES_TEMAKI),
    new Comida(3, 'Uramaki', 8, true, 'comida', INGREDIENTES_TEMAKI),
    new Comida(4, 'Sashimi (Porção)', 20.75, true, 'comida', INGREDIENTES_SASHIMI),
]

export const BEBIDAS: Bebida[] = [
    new Bebida(5, 'Coca-Cola', 5, true, 'bebida', INGREDIENTES_BEBIDA_COCA),
    new Bebida(6, 'Fanta', 5, true, 'bebida', INGREDIENTES_BEBIDA_FANTA),
    new Bebida(7, 'Heineken', 5, true, 'bebida', INGREDIENTES_BEBIDA_HEINEKEN),
    new Bebida(8, 'Sprite', 5, true, 'bebida', INGREDIENTES_BEBIDA_SPRITE)
]
